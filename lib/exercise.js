...
function execEach(__, sets, file, handleResult, callback) {
  var result = []
  var i = 0
  var next = function () {
    var input = sets[i]
...
module.exports = function (folder, opts) {
  ...
  return {
    ...
    verify: function (args, callback) {
      ...
      var __ = this.i18n.__
      execEach(__, sets, solution, opts.handleResult, function (err, result) {
        if (err) {
          return handleError(err)
        }
        execEach(__, sets, path.resolve(process.cwd(), args[0]), opts.handleResult, function (err2, result2) {
          if (err2) {
    ...
    run: function (args, callback) {
      var sets = opts.createSampleSets()
      var __ = this.i18n.__
      execEach(__, sets, path.resolve(process.cwd(), args[0]), opts.handleResult, function (err, result) {
        if (err) {
          return callback(err)
        }
        console.log(result)
